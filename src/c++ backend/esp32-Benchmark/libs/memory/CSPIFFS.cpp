...
bool CSPIFFS::readFile(fs::FS &fs, const char * path) {
...
bool CSPIFFS::writeFile(fs::FS &fs, const char * path, String message){
...
bool CSPIFFS::appendFile(fs::FS &fs, const char * path, String message){
...
bool CSPIFFS::renameFile(fs::FS &fs, const char * path1, const char * path2){
...
bool CSPIFFS::deleteFile(fs::FS &fs, const char * path){
    if(!fs.remove(path)){
        return false;
    }
